...
import { createEmailContent, publishToMailchimp } from './mailchimp-service';
...
class PublicationTask {
  ...
  */
  ...
  /**
   * Create the email content for the press release and publish it to Mailchimp
   */
  async publish() {
    const pressRelease = await createEmailContent(this.uri, this.pressRelease);
    await publishToMailchimp(pressRelease);
  }
 ...
 * and are linked to the Mailchimp publication channel.
 *
 * @public
*/
